...
Simply clone the repository, navigate to the cloned directory,and then run the file, using the -h flag to understand what inputs you should be using
And that's it! No packages outside the standard library need to be installed
## Technologies
...
This tends to return more accurate results than ESI, but is still not perfect, as ESI and zkill dont display every single killmail
